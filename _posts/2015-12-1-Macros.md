...
C is cool for many reasons, one of them being harnessing the power of the preprocessor. I have heard [rumors that C++ fans don't like the preprocessor](http://stackoverflow.com/questions/1637332/static-const-vs-define), which is a shame since macros are awesome.
